...
<div class="wp-block-column is-vertically-aligned-center left-side" style="flex-basis:25%" id="left-side"><!-- wp:heading {"align":"left","fontSize":"large","fontFamily":"body"} -->
<h2 class="wp-block-heading has-body-font-family has-large-font-size">Products</h2>
<!-- /wp:heading -->

<!-- wp:navigation {"ref":3176,"overlayMenu":"never","fontSize":"small","layout":{"type":"flex","orientation":"vertical"}} /-->
...
<!-- wp:social-link {"url":"https://wa.me/436765769550","service":"whatsapp","label":"#"} /--></ul>
<!-- /wp:social-links --></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"center","width":"35%","UAGHideMob":true,"UAGHideTab":true,"UAGResponsiveConditions":true} -->
<div class="wp-block-column is-vertically-aligned-center uag-hide-tab uag-hide-mob" style="flex-basis:35%"><!-- wp:image {"lightbox":{"enabled":false},"id":2691,"aspectRatio":"3/4","scale":"contain","sizeSlug":"full","linkDestination":"custom","className":"is-style-rounded"} -->
<figure class="wp-block-image size-full is-style-rounded"><a href="https://www.melomi.at/Erdbeeren-p574257549"><img src="http://www.melomi.at/wp-content/uploads/2025/03/image.jpg" alt="" class="wp-image-2691" style="aspect-ratio:3/4;object-fit:contain"/></a></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<!-- wp:navigation {"ref":3194,"openSubmenusOnClick":true,"overlayMenu":"never","fontSize":"large","layout":{"type":"flex","orientation":"vertical","flexWrap":"nowrap"}} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->